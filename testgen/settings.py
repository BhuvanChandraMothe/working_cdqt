...
IS_DEBUG: bool = os.getenv("TESTGEN_DEBUG", "True").lower() == "yes"
"""
...
DATABASE_USER: str = os.getenv("TG_METADATA_DB_USER", 'postgres')
"""
...
DATABASE_PASSWORD: str = os.getenv("TG_METADATA_DB_PASSWORD", 'bhuvan')
"""
...
DATABASE_NAME: str = os.getenv("TG_METADATA_DB_NAME", "postgres")
"""
...
DATABASE_SCHEMA: str = os.getenv("TG_METADATA_DB_SCHEMA", "tgapp")
"""
